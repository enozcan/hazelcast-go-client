...
func DecodeMapAddNearCacheInvalidationListenerResponse(clientMessage *proto.ClientMessage) types.UUID {
...
func HandleMapAddNearCacheInvalidationListener(clientMessage *proto.ClientMessage, handleIMapInvalidationEvent func(key *serialization.Data, sourceUuid types.UUID, partitionUuid types.UUID, sequence int64), handleIMapBatchInvalidationEvent func(keys []*serialization.Data, sourceUuids []types.UUID, partitionUuids []types.UUID, sequences []int64)) {
